...
function TrainingItem(props) {
  ...
  }, [props.favourites, props.trainingName]);

  const handleFavoriteClick = () => {
    if (isFavorite) {
      removeFavourites(props.trainingName);
    } else {
      addFavourites(props.trainingName);
    }
    ...
    <div className="item">
      ...
      <div className="title-container">
        <h3 className="exerciseNameItem">
          {formatTrainingName(props.trainingName)}
        </h3>
    ...
    {isModalOpen && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <h2>{props.trainingName} Details</h2>
